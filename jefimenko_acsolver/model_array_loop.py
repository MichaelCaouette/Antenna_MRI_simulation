...
if __name__ == '__main__':
    ...
    v_geo.add_line(xline, yline, zline, color='C1', 
    ...
    out = get_pringle_pts(x0, y0, z0, n_direction , 
                                          ...
                                          Npts=50)
    xline, yline, zline = list_pts_to_each_lines(out) 
    v_geo.add_line(xline, yline, zline, color='C2', 
                   label='Pringle R_cyl=%.4f'%R_cyl, show_corner=True)
    ...
    out = get_pringle_pts(x0, y0, z0, n_direction , 
                                          ...
                                          Npts=50)
    xline, yline, zline = list_pts_to_each_lines(out) 
    v_geo.add_line(xline, yline, zline, color='C3', 
    ...
    # =============================================================================
    # View the geometry of the array of loops
    # =============================================================================
