...
import numpy as np
from integral_Jeffimenko_segment import IntegralJeffimenko
...
class FieldSegment():
    ...
    def cross_prod(self, v, u):
        ...
        """
        _debug('FieldSegment: cross_prod')
    ...
    def coordinate_mapping(self, vec_r, vec_r1, vec_r2 ):
        ...
        return:
            ...
            of 2022-05-23. 
        """
        _debug('FieldSegment: coordinate_mapping')
    ...
    def get_field_spatial(self, x, y, z, cst='all'):
        ...
        """
        _debug('FieldSegment: get_field_spatial')
        ...
        if   cst=='all':
            ...
            print('ERROR in FieldSegment.get_field_spatial')
    ...
    def get_short_wire(self, x, y, z, t, cst='all'):
        ...
        """
        _debug('FieldSegment: get_short_wire')
        ...
        if   cst=='all':
            ...
            print('ERROR in FieldSegment: get_short_wire')
            print('The variable cst must be either all, non or just_scale')
    ...
    def get_quasistatic(self, x, y, z, t, cst='all'):
        ...
        """
        _debug('FieldSegment: get_quasistatic')
        ...
        if   cst=='all':
            ...
            print('ERROR in FieldSegment: get_quasistatic')
...
if __name__ == '__main__':
    ...
    self = FieldSegment(vec_r1, vec_r2, f=f, I=2.3)
