...
# The design to use
from jefimenko_acsolver.model_5_loops import Flower5loop
...
center_ref = [0, -.005, -0.005] # m, Origin of the coil. 
Rsphere = 0.040  # m, radius of the sphere on which lays the coil
R_loops = 0.025 # m, radius of each loop
theta0_missing = 45*3.14159/180 # Angle of the missing loop
...
self = Flower5loop(Rsphere=Rsphere, 
                   ...
                   angle_missing_loop=theta0_missing,
                   pos_center_sphere = center_ref, # Origin of the the sphere
...
my_freqs   = zeros + my_freq  # Same frequency in every loop
